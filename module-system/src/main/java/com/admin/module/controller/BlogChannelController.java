...
public class BlogChannelController extends ShiroController {
    ...
    public RestResponse add(BlogChannel blogChannel){
        ...
        if(blogChannel.getParentId() == null){
            ...
            Object o = blogChannelService.getObj(new QueryWrapper<BlogChannel>()
                    .select("max(sort)").isNull("parent_id")
                    .eq("del_flag",false));
            int sort = 0;
            if(o != null){
                sort =  (Integer)o +10;
