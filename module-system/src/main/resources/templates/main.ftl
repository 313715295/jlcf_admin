...
<div class="row">
    ...
    <div class="sysNotice col">
        ...
        <table class="layui-table">
            ...
            <tr>
                <td>JAVA运行环境</td>
                <td class="author">${site.javaRunEnvironment}</td>
            </tr>
            <tr>
                <td>JAVA虚拟机</td>
                <td class="author">${site.javaVM}</td>
            </tr>
            <tr>
                <td>数据库版本</td>
                <td class="dataBase">${site.IDatabase}</td>
            </tr>
            <tr>
                <td>系统账户</td>
                <td class="dataBase">${site.systemUser}</td>
            </tr>
            <tr>
                <td>目录、临时目录</td>
                <td class="dataBase">${site.dir}, ${site.tmpdir}</td>
            </tr>
            <tr>
                <td>内存详情</td>
                <td class="dataBase">已用：${site.usedMemory}, 可用：${site.useAbleMemory}, 最大：${site.maxMemory}</td>
            </tr>
            <tr>
                <td>当前用户角色</td>
                <td class="userRights">
