...
//
//import com.admin.base.MySysUser;
//import com.admin.commons.exceptions.GlobalExceptionAndCheckHealthHandler;
//import com.admin.entity.Log;
//import com.admin.exception.GlobalExceptionHandler;
//import com.admin.util.ToolUtil;
...
//
//    @Autowired
//    private GlobalExceptionAndCheckHealthHandler exceptionHandler;
//
//    private Log sysLog;
//
//    @Pointcut("@annotation(com.admin.commons.annotation.SysLog)")
//    public void webLog() {
//    }
//
//    @Before("webLog()")
...
//        com.admin.annotation.SysLog mylog = method.getAnnotation(com.admin.annotation.SysLog.class);
//        if (mylog != null) {
//            //注解上的描述
